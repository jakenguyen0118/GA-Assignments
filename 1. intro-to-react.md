...
The following questions are based on the article you were asked to read for homeworkk: [javascript-frameworks-vs-libraries](https://skillcrush.com/blog/javascript-frameworks-vs-libraries/) 
...
A few things have been removed from this CodeSandbox and for this demo we will focus on:
...
We only have to use `ReactDOM.render()` once when `mounting` React to our html and many tools such as CodeSandbox will do this for us. 
...
Here is the final [CodeSandbox Solution]() - provided once lecture completed
